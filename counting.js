...
function detect(r,g,b){
	var apiKey = 'tU6yJRao5h8VPb4dMVliWJdZGpqu9tbcaPwTedEY+Qjvq2cP1hrn7Wkvmc/jAqYA/HbIKnTdLiKeLgzWNJly/Q==';
	var host = "ussouthcentral.services.azureml.net";
	var path = "/workspaces/8c128539c26848f6b3c30fe6532a906e/services/e00ffe6848ec4488946b2c02ee632aec/execute?api-version=2.0&details=true";
	...
	var request = https.request(requestOptions, function(response){
		...
		response.on('data',function(data){
			var billValue = getColorName(data.toString());
			var integerValue = parseInt(billValue);
			if(integerValue){
				console.log(integerValue+" reais");
				sendData({billValue: integerValue, tstamp: null});
			}
...
function getColorName(responseJSON){
	...
	return data.Results.output1.value.Values[0][9];
}
